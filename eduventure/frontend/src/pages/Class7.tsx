...
import { class7Curriculum } from '../data/class7Curriculum';
import { Subject, Chapter } from '../data/class6Curriculum'; // Reusing types

const Class7: React.FC = () => {
    const [activeSubject, setActiveSubject] = useState<Subject>(class7Curriculum['math']);
    const [activeChapter, setActiveChapter] = useState<Chapter | null>(null);

    const subjects = Object.values(class7Curriculum);
                ...
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <div>
                        <h1 className="text-4xl font-extrabold tracking-tight flex items-center gap-3">
                            ...
                            Class 7: {activeSubject.name}
                        </h1>
                        <p className="mt-2 text-white/90 text-lg font-medium">
                            Advanced learning with interactive exercises!
                        </p>
                    </div>
